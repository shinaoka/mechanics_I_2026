...
.PHONY: build serve clean enrollment-pdf exercises-pdf exercises-pdf-w1 exercises-pdf-w2 exercises-pdf-w3 exercises-pdf-w4 exercises-pdf-w5 exercises-pdf-w6 exercises-pdf-w7 preview-pdf preview-pdf-folder
...
exercises-pdf: exercises-pdf-w1 exercises-pdf-w2 exercises-pdf-w3 exercises-pdf-w4 exercises-pdf-w5 exercises-pdf-w6 exercises-pdf-w7
