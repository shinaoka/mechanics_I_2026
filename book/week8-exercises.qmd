...
が成り立つ力と定義する. 次の各力について, 保存力であるかを判定せよ. 保存力である場合は, 位置エネルギー $U(x,y)$ を 1 つ求めよ. 保存力でない場合は, その理由を述べよ.
...
\mathbf{e}_r=\frac{1}{r}(x,y),\qquad
\mathbf{e}_\theta=\frac{1}{r}(-y,x)
$$
...
\begin{cases}
\mathbf{0}, & r\le 1,\\
\dfrac{\cos\theta}{r}\mathbf{e}_\theta, & r>1
\end{cases}
$$
