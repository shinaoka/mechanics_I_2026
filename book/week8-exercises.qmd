...
が保存することを示し, $r$ 方向の運動を有効ポテンシャルの 1 次元問題として書き直せ.

4. 有効ポテンシャルの概形を $L=0$ と $L\ne0$ の場合で比べよ. また, 反転点 $r_{\min},r_{\max}$ が満たす方程式を求めよ. ただし

$$
\rho=\frac{r^2}{a^2},\qquad
\epsilon=\frac{E}{U_0},\qquad
\lambda=\frac{L^2}{2mU_0a^2}
$$
...
1. 原点が平衡点であることを示せ. さらに, 原点のまわりで $U(x,y)$ を 2 次までテイラー展開せよ.

2. 1. で得た 2 次近似を用いて, 原点近くの運動方程式を $x,y$ について書け. また, その一般解を求めよ.
